...
public class SignalingController {
    ...
    @MessageMapping("/disconnect/{camKey}/{roomId}")
    @SendTo("/topic/disconnect/{camKey}/{roomId}")
    public String disconnect(@DestinationVariable(value = "roomId") String roomId,
                             @DestinationVariable(value = "camKey") String camKey) {
        log.info("[DISCONNECT] {} : {}", camKey, roomId);
        return camKey;
    }
}